...
// KLEE alone generates 17631 tests in 30s
// 26 uncoverable decisions?
...
int ssl3_connect(void) 
{
  ...
  s__state = 12292;
  blastFlag = 0;
  tmp = __tmp; //__VERIFIER_nondet_int();
  cb = 0;
  ret = -1;
  skip = 0;
  tmp___0 = 0;
  ...
  tmp___1 = __tmp___1; //__VERIFIER_nondet_int();
  if (tmp___1 & 12288) {
    tmp___2 = __tmp___2; //__VERIFIER_nondet_int();
    if (tmp___2 & 16384) {
                                                                    ...
                                                                    if (s__state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        if (s__init_buf___0 == 0) {
                                                                          buf = __buf; //__VERIFIER_nondet_int();
                                                                          if (buf == 0) {
                                                                            ret = -1;
                                                                            goto end;
                                                                          } else {
