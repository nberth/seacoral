  ...
  [%expect {|
    ...
    literal:
      heap: struct s1 _heap_obj_5_;
            ...
            (void) memcpy (&(_heap_obj_7_),
                           (struct s2){.s12 = &_heap_obj_5_, .d = 2.36943e-38, .e = &_heap_obj_6_},
                           sizeof (struct s2));
    ...
    literal:
      heap: struct s1 _heap_obj_3_[0];
            ...
            (void) memcpy (&(_heap_obj_7_),
                           (struct s2[2]){{.s12 = _heap_obj_3_, .d = 9.55147e-38, .e = _heap_obj_4_}, {.s12 = _heap_obj_5_, .d = 9.55147e-38, .e = _heap_obj_6_}},
                           sizeof (struct s2[2]));
