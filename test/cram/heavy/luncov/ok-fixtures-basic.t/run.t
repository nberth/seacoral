  ...
  $ seacoral --tools luncov --files fail.c
  ...
  [A]{Sc} Oracle statistics: fails: none
  [A]{Sc} No label, no coverage
  $ seacoral --tools luncov --files uncov.c
  ...
  [A]{Sc}        1: Uncoverable
                 2: Unknown
          Coverage: (0/2) 50.0%
  $ seacoral --tools luncov --files fail-n-uncov.c
  ...
  [A]{Sc}        1: Unknown
                 2: Uncoverable
          Coverage: (0/2) 50.0%
  $ seacoral --tools luncov --files fail-n-uncov.c --ignore-oracle-failures
