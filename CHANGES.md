...
### Fixed
- Random failures with `e-acsl-gcc.sh` in Docker image [#77](https://github.com/OCamlPro/seacoral/pull/77) (fix for [Issue #62](https://github.com/OCamlPro/seacoral/issues/62))
