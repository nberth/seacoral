...
# -*- coding: utf-8 -*-
#
# seacoral documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'seacoral'
copyright = 'OCamlPro'
author = 'Steven de Oliveira <steven.de-oliveira@ocamlpro.com> & Nicolas Berthier <nicolas.berthier@ocamlpro.com>'
...
man_pages = [
    (master_doc, 'seacoral', 'seacoral Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'seacoral', 'seacoral Documentation',
     author, 'seacoral', 'One line description of project.',
     'Miscellaneous'),
]
