...
(** [share_test ~on_share ~covers ~outcome ~toolname corpus v] promises to share
    a given test with value [v], generated by a tool named [toolname], in
    [corpus]. If provided, [on_share] is called immediately with the identifier
    computed from [v].  *)
val share_test
